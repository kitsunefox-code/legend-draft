...
for(const f of ['players.js','data-fixes.js','party.js','ss.js','game.js','premium.js']){let s=fs.readFileSync(''+f,'utf8');if(f==='game.js')s=s.replace(/^buildFrontPage\(\);/m,'');vm.runInContext(s,ctx,{filename:f});}
