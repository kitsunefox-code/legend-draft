...
SCENES.abs = (function(){
  ...
  function truthOf(c){
    ...
    const pen = inside ? rnd1(1.2, 6.5) : -rnd1(1.2, 6.5);   // 球の縁が線を越える深さ(px)
    const off = R - pen;
  ...
  function play(c){
    ...
    setLbl("満塁 フルカウント");
    const col = teamCol(c.batting ? c.opp : c.victim, "#4f8fe8");
    ...
    RV.timer = setTimeout(function(){ RV.raf = requestAnimationFrame(f); }, 500);
  }
