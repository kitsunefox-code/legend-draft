...
const NPB_SEGS = ["seg_base.json","seg_middle.json","seg_corner.json","seg_of_classic.json","seg_of_modern.json","seg_sp_classic.json","seg_sp_modern.json","seg_relief.json","seg_mgr.json","seg_prewar.json","seg_60s90s.json","seg_modern2.json","seg_bat3.json","seg_pit3.json","seg_mgr2.json",
  ...
  "seg_mgr3.json","seg_mgr4.json","seg_modern3.json","seg_modern4.json","seg_mgr5.json"];
const seen = new Set();
const db = [];
...
const mlb = [];
const seenM = new Set();
for(const f of ["seg_mlb.json","seg_mlb2.json","seg_mlb3.json","seg_mlb4.json","seg_mlb5.json","seg_mlb6.json","seg_mlb7.json","seg_mlb8.json","seg_mlb9.json","seg_mlb10.json","seg_mlb_mgr.json","seg_mlb_mgr2.json"]){
  for(const raw of loadSeg(f)){
